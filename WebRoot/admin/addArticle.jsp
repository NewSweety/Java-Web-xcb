...
<html>
 ...
 <script language="javascript" type="text/javascript" src="<%=basePath%>/My97DatePicker/WdatePicker.js"></script>
  ...
  <div class="main-frame">
    ...
    <div class="right">
   <div class="admin">
		    <h1 class="title">添加新闻<a href="admin/articleList.jsp" class="back-btn">返回</a></h1>
	...
	<table>
		    ...
		    <td id="err_nav_id"></td>
		     ...
		     <tr><td>发布时间：</td><td><input  readonly="readonly"  id="article_data" name="article_data" autocomplete="off" maxlength="20" type="text" onClick="WdatePicker()" /></td><td id="err_article_data"></td></tr>
		     <tr>
		         <td valign="top">新闻正文： </td>
		     <td colspan="2">
		          <textarea name="content1" rows="" cols="" style="width:680px;height:400px;"></textarea>
		     </td>    
		     </tr>
